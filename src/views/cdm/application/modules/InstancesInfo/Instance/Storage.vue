<template>
  <a-spin :spinning="o.loading">
    ...
    <empty-provider :isEmpty="o.isEmpty" :itemProps="o.empty">
      <div class="flex-column" style="height: 250px">
        <detail :data="data" :colSpan="2" justify="end" :colon="false" />
  ...
  methods: {
    loadData () {
      this.data = this.data.map(u => Object.assign(u, {
        value: deepGet(this.o.instance?.storage, u.key)
      }))
      this.diskList = this.o.instance?.storage?.disk.map(u => [
        {
          key: 'name',
          title: '磁盘名称'
        },
